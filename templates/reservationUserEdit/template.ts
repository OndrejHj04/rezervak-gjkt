...
export default function NewReservationMember(
  ...
  Detail rezervace:
  <ul>
    <li>Datum: ${dayjs(reservation.from_date).format("DD.MM.YYYY")} - ${dayjs(reservation.to_date).format("DD.MM.YYYY")}</li>
    <li>Vedoucí: ${reservation.leader.first_name} ${reservation.leader.last_name}</li>
